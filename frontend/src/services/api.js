...
export const parentApi = {
  ...
  // Search parents (with empty values filtered out)
  search: (params) => {
    ...
    return api.get('/parents/search', { params: filteredParams })
  },
  ...
  // Add note to parent
  addNote: (parentId, data) =>
    api.post(`/parents/${parentId}/notes`, data, {
